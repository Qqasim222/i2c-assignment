...
const AboutUsDetail = () => {
  return (
    <div className="w-full relative bg-[#F6FBF8] h-full lg:h-[116px] rounded-xl p-[10px] lg:items-center lg:grid lg:grid-cols-3 ring-[#46B0E6] ring-offset-2 shadow-2xl mt-10 lg:mt-0 lg:mx-6">
