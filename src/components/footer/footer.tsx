    ...
    <div>
      <div className="md:flex md:items-center md:justify-between md:mt-6">
        ...
        <div className="md:flex md:justify-center md:items-center md:space-x-6 md:text-[16px] md:mt-0 mt-3 font-normal text-[#515151]">
          ...
          <button className="bg-[#46B0E6] hover:bg-blue-700 mt-2 w-[200px] h-[51px] text-white font-[700] py-2 px-4 rounded-full md:w-[150px] md:h-[51px] ring-[#46B0E6] ring-offset-2 shadow-2xl">
            Contact us
          </button>
        </div>
      </div>
